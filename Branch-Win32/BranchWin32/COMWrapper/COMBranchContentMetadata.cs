...
namespace COMWrapper
{
    public class COMBranchContentMetadata : ICOMBranchContentMetadata
    {
        ...
        public BranchContentMetadata ParseCOMMetadata()
        {
            ...
            metadata.ContentSchema = EnumUtils.TryParse<BranchContentSchema>(ContentSchema);
            metadata.Quantity = Quantity;
            metadata.Price = Price;
            metadata.CurrencyType = EnumUtils.TryParse<BranchCurrencyType>(CurrencyType);
            metadata.Sku = Sku;
            metadata.ProductName = ProductName;
            metadata.ProductBrand = ProductBrand;
            metadata.ProductCategory = EnumUtils.TryParse<BranchProductCategory>(ProductCategory);
