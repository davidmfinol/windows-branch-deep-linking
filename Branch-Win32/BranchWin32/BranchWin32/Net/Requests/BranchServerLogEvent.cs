...
namespace BranchSdk.Net.Requests {
    public class BranchServerLogEvent : BranchServerRequest {
        ...
        public BranchServerLogEvent(string requestPath, string eventName, bool isStandartEvent, List<BranchUniversalObject> buoList, Dictionary<string, object> topLevelProperties, Dictionary<string, object> standartProperties, Dictionary<string, object> customProperties) {
