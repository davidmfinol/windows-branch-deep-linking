...
namespace BranchSdk {
    ...
    public class Branch {
        ...
        public void SendCommerceEvent(BranchCommerceEvent commerceEvent, Dictionary<string, object> metadata, UserCompletedActionDelegate callback)
        {
            BranchServerActionCompleted request = new BranchServerActionCompleted(BranchEnumUtils.GetEventName(BranchStandartEvent.PURCHASE), commerceEvent, metadata);
            request.RequestType = RequestTypes.POST;
