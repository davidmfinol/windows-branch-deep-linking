namespace BranchSdk.Enum {
    public static class BranchEnumExtensions {
        public static BranchCurrencyType ParseToCurrencyType(this string iso4217Code) {
        ...
        public static BranchContentSchema ParseToContentSchema(this string name) {
        ...
        public static BranchCondition ParseToCondition(this string name) {
        ...
        public static string GetKey(this LinkParam linkParam) {
            switch(linkParam) {
        ...
        public static string GetEventName(this BranchStandartEvent branchEvent) {
            switch(branchEvent) {
        ...
        public static string GetPath(this RequestPath requestPath) {
            switch(requestPath) {
        ...
        public static string GetKey(this BranchJsonKey jsonKey) {
            switch(jsonKey) {
        ...
        public static BranchProductCategory ParseToProductCategory(this string category) {
        ...
        public static string ProductCategoryToString(this BranchProductCategory category) {
            switch (category) {
